<div class="col-lg-12">
    ...
    <div class="col-lg-10">
        ...
        <div class="form-group">
            ...
            <select name="" id="" style="" class="city_select">
...
{{--kar kard--}}
    <div class="col-lg-12">
        <div class="form-group">
            ...
            <input type="text" style="border: 1px solid #cccccc;height: 32px;width: 100%;border-radius: 4px">
...
{{--gheymat --}}
    ...
    <div class="col-lg-8" style="float: left;margin-top: 60px">
        <div class="form-group">
            <input type="text" name="" value="" disabled="disabled" style="width: 100%">
        </div>
    </div>
    ...
    <div class="col-lg-2" style="float:right;">
        ...
        <div class="form-group">
            ...
            فروشی
            <input class="form-control" type="radio" name="type[]" value="1" style="margin-top: -16px;
    ...
    <div class="col-lg-3" style="float:right;">
        ...
        <div class="form-group">
            ...
            اجاره ای
            <input class="form-control" type="radio" name="type[]" value="1" style="margin-top: -16px;width: 24px;
...
{{--tozihate agahi--}}
    ...
    <div class="col-lg-12" style="margin-top: 30px;text-align: left">
        ...
        <button type="button" class="btn btn-danger" style="background-color: #c00c1a;color: white;width: 150px">
